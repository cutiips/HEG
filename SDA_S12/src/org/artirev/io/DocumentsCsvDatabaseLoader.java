...
import static org.artirev.business.Document.checkNumeric;
import static org.artirev.io.FileDatabaseUtils.findColumnIndex;
            ...
            if(referenceColumnIndex != notFoundColumnIndex) {
                ...
                if(references != null && references.length() > 0) {
                    ...
                    for (String referenceString : referencesArray) {
                        // .replaceAll("[^,.()a-zA-Z0-9]+","") // TODO --------------------------
                        Reference reference = new Reference(referenceString); // TODO lower case ----------------------
